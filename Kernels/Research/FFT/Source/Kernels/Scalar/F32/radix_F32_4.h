...
#ifndef _RADIX_F32_4_H
#define _RADIX_F32_4_H
...
struct radix<DIRECT,float32_t, 4,inputstrideenabled>{
...
complex<float32_t> a[4];
complex<float32_t> res[4];
...
***************/
template<int inputstrideenabled> 
struct radix<INVERSE,float32_t, 4,inputstrideenabled>{
