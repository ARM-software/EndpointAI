...
#ifndef _RADIX_F32_8_H
#define _RADIX_F32_8_H
...
struct radix<DIRECT,float32_t, 8,inputstrideenabled>{

static constexpr float32_t C0_8_tw{0.7071067811865476f};
  
static constexpr float32_t C0_8_notw{0.7071067811865476f};
...
complex<float32_t> a[8];
complex<float32_t> res[8];
...
a[6] = memory<complex<float32_t>>::load(in,6 * stageLength * strideFactor);
a[7] = memory<complex<float32_t>>::load(in,7 * stageLength * strideFactor);
...
memory<complex<float32_t>>::store(in,6 * stageLength * strideFactor , res[6]);
memory<complex<float32_t>>::store(in,7 * stageLength * strideFactor , res[7]);
...
memory<complex<float32_t>>::store(out,6 * stageLength * strideFactor , res[6]);
memory<complex<float32_t>>::store(out,7 * stageLength * strideFactor , res[7]);
...
a[6] = memory<complex<float32_t>>::load(in,6 * strideFactor);
a[7] = memory<complex<float32_t>>::load(in,7 * strideFactor);
...
memory<complex<float32_t>>::store(in,6 * strideFactor , res[6]);
memory<complex<float32_t>>::store(in,7 * strideFactor , res[7]);
...
memory<complex<float32_t>>::store(out,6 * strideFactor , res[6]);
memory<complex<float32_t>>::store(out,7 * strideFactor , res[7]);
...
***************/
template<int inputstrideenabled> 
struct radix<INVERSE,float32_t, 8,inputstrideenabled>{
