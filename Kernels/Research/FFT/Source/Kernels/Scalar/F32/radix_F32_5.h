...
#ifndef _RADIX_F32_5_H
#define _RADIX_F32_5_H
...
struct radix<DIRECT,float32_t, 5,inputstrideenabled>{

static constexpr float32_t C0_5_tw{0.30901699437494745f};
  static constexpr float32_t C1_5_tw{0.8090169943749475f};
  static constexpr float32_t C2_5_tw{0.5877852522924731f};
  static constexpr float32_t C3_5_tw{0.9510565162951535f};
  
static constexpr float32_t C0_5_notw{0.30901699437494745f};
  static constexpr float32_t C1_5_notw{0.8090169943749475f};
  static constexpr float32_t C2_5_notw{0.5877852522924731f};
  static constexpr float32_t C3_5_notw{0.9510565162951535f};
...
complex<float32_t> a[5];
complex<float32_t> res[5];
...
***************/
template<int inputstrideenabled> 
struct radix<INVERSE,float32_t, 5,inputstrideenabled>{
