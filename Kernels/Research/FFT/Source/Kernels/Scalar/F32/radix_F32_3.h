...
#ifndef _RADIX_F32_3_H
#define _RADIX_F32_3_H
...
struct radix<DIRECT,float32_t, 3,inputstrideenabled>{

static constexpr float32_t C0_3_tw{0.8660254037844386f};
  static constexpr float32_t C1_3_tw{0.5f};
  
static constexpr float32_t C0_3_notw{0.8660254037844386f};
  static constexpr float32_t C1_3_notw{0.5f};
...
complex<float32_t> a[3];
complex<float32_t> res[3];
...
***************/
template<int inputstrideenabled> 
struct radix<INVERSE,float32_t, 3,inputstrideenabled>{
