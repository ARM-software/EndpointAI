...
static constexpr Q15 C0_8_tw{(q15_t)0x5A82};
  
static constexpr Q15 C0_8_notw{(q15_t)0x5A82};
...
res[1].re =  narrow<NORMALNARROW,Q15>::run(( decq( widen<Q15>::run(tmp_8)  ,1)   + tmp_16) )  ;
...
res[3].re =  narrow<NORMALNARROW,Q15>::run(( decq( widen<Q15>::run(tmp_21)  ,1)   + tmp_25) )  ;
res[4].re = ( decq(tmp_2,1)   -  decq(tmp_5,1)  ) ;
res[5].re =  narrow<NORMALNARROW,Q15>::run(( decq( widen<Q15>::run(tmp_8)  ,1)   - tmp_16) )  ;
res[6].re = ( decq(tmp_17,1)   -  decq(tmp_20,1)  ) ;
res[7].re =  narrow<NORMALNARROW,Q15>::run(( decq( widen<Q15>::run(tmp_21)  ,1)   - tmp_25) )  ;
...
res[1].im =  narrow<NORMALNARROW,Q15>::run(( decq( widen<Q15>::run(tmp_32)  ,1)   + tmp_34) )  ;
...
res[3].im =  narrow<NORMALNARROW,Q15>::run(( decq( widen<Q15>::run(tmp_37)  ,1)   - tmp_39) )  ;
res[4].im = ( decq(tmp_28,1)   -  decq(tmp_29,1)  ) ;
res[5].im =  narrow<NORMALNARROW,Q15>::run(( decq( widen<Q15>::run(tmp_32)  ,1)   - tmp_34) )  ;
res[6].im = ( decq(tmp_36,1)   +  decq(tmp_35,1)  ) ;
res[7].im =  narrow<NORMALNARROW,Q15>::run(( decq( widen<Q15>::run(tmp_37)  ,1)   + tmp_39) )  ;
...
tmp_17 = ( decq( widen<Q15>::run(tmp_8)  ,1)   + tmp_16) ;
...
tmp_25 = ( decq( widen<Q15>::run(tmp_20)  ,1)   + tmp_24) ;
res[1].re =  narrow<NORMALNARROW,Q15>::run((w[0].re *  narrow<NORMALNARROW,Q15>::run(tmp_17)    - w[0].im *  narrow<NORMALNARROW,Q15>::run(tmp_25)   ) )  ;
...
res[2].re =  narrow<NORMALNARROW,Q15>::run((w[1].re * tmp_30  - w[1].im * tmp_35 ) )  ;
tmp_36 = ( decq(tmp_6,1)   -  decq(tmp_7,1)  ) ;
tmp_37 = ( decq(tmp_22,1)   -  decq(tmp_21,1)  ) ;
tmp_38 = (C0_8_tw) * tmp_37 ;
tmp_39 = ( decq( widen<Q15>::run(tmp_36)  ,1)   + tmp_38) ;
tmp_40 = ( decq(tmp_19,1)   +  decq(tmp_18,1)  ) ;
tmp_41 = ( decq(tmp_11,1)   -  decq(tmp_14,1)  ) ;
tmp_42 = (C0_8_tw) * tmp_41 ;
tmp_43 = ( decq( widen<Q15>::run(tmp_40)  ,1)   - tmp_42) ;
res[3].re =  narrow<NORMALNARROW,Q15>::run((w[2].re *  narrow<NORMALNARROW,Q15>::run(tmp_39)    - w[2].im *  narrow<NORMALNARROW,Q15>::run(tmp_43)   ) )  ;
...
res[4].re =  narrow<NORMALNARROW,Q15>::run((w[3].re * tmp_44  - w[3].im * tmp_47 ) )  ;
tmp_48 = ( decq( widen<Q15>::run(tmp_8)  ,1)   - tmp_16) ;
tmp_49 = ( decq( widen<Q15>::run(tmp_20)  ,1)   - tmp_24) ;
res[5].re =  narrow<NORMALNARROW,Q15>::run((w[4].re *  narrow<NORMALNARROW,Q15>::run(tmp_48)    - w[4].im *  narrow<NORMALNARROW,Q15>::run(tmp_49)   ) )  ;
tmp_50 = ( decq(tmp_26,1)   -  decq(tmp_29,1)  ) ;
tmp_51 = ( decq(tmp_34,1)   +  decq(tmp_33,1)  ) ;
res[6].re =  narrow<NORMALNARROW,Q15>::run((w[5].re * tmp_50  - w[5].im * tmp_51 ) )  ;
tmp_52 = ( decq( widen<Q15>::run(tmp_36)  ,1)   - tmp_38) ;
tmp_53 = ( decq( widen<Q15>::run(tmp_40)  ,1)   + tmp_42) ;
res[7].re =  narrow<NORMALNARROW,Q15>::run((w[6].re *  narrow<NORMALNARROW,Q15>::run(tmp_52)    - w[6].im *  narrow<NORMALNARROW,Q15>::run(tmp_53)   ) )  ;
res[0].im = ( decq(tmp_45,1)   +  decq(tmp_46,1)  ) ;
res[1].im =  narrow<NORMALNARROW,Q15>::run((w[0].re *  narrow<NORMALNARROW,Q15>::run(tmp_25)    + w[0].im *  narrow<NORMALNARROW,Q15>::run(tmp_17)   ) )  ;
res[2].im =  narrow<NORMALNARROW,Q15>::run((w[1].re * tmp_35  + w[1].im * tmp_30 ) )  ;
res[3].im =  narrow<NORMALNARROW,Q15>::run((w[2].re *  narrow<NORMALNARROW,Q15>::run(tmp_43)    + w[2].im *  narrow<NORMALNARROW,Q15>::run(tmp_39)   ) )  ;
res[4].im =  narrow<NORMALNARROW,Q15>::run((w[3].re * tmp_47  + w[3].im * tmp_44 ) )  ;
res[5].im =  narrow<NORMALNARROW,Q15>::run((w[4].re *  narrow<NORMALNARROW,Q15>::run(tmp_49)    + w[4].im *  narrow<NORMALNARROW,Q15>::run(tmp_48)   ) )  ;
res[6].im =  narrow<NORMALNARROW,Q15>::run((w[5].re * tmp_51  + w[5].im * tmp_50 ) )  ;
res[7].im =  narrow<NORMALNARROW,Q15>::run((w[6].re *  narrow<NORMALNARROW,Q15>::run(tmp_53)    + w[6].im *  narrow<NORMALNARROW,Q15>::run(tmp_52)   ) )  ;
