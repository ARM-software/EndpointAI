...
res[1].re =  narrow<NORMALNARROW,Q15>::run((w[0].re * tmp_4  - w[0].im * tmp_7 ) )  ;
...
res[2].re =  narrow<NORMALNARROW,Q15>::run((w[1].re * tmp_8  - w[1].im * tmp_11 ) )  ;
tmp_12 = ( decq(tmp_2,1)   -  decq(tmp_3,1)  ) ;
tmp_13 = ( decq(tmp_6,1)   +  decq(tmp_5,1)  ) ;
res[3].re =  narrow<NORMALNARROW,Q15>::run((w[2].re * tmp_12  - w[2].im * tmp_13 ) )  ;
res[0].im = ( decq(tmp_9,1)   +  decq(tmp_10,1)  ) ;
res[1].im =  narrow<NORMALNARROW,Q15>::run((w[0].re * tmp_7  + w[0].im * tmp_4 ) )  ;
res[2].im =  narrow<NORMALNARROW,Q15>::run((w[1].re * tmp_11  + w[1].im * tmp_8 ) )  ;
res[3].im =  narrow<NORMALNARROW,Q15>::run((w[2].re * tmp_13  + w[2].im * tmp_12 ) )  ;
