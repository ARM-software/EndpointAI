...
static constexpr Q15 C0_3_tw{(q15_t)0x6EDA};
  static constexpr Q15 C1_3_tw{(q15_t)0x4000};
  
static constexpr Q15 C0_3_notw{(q15_t)0x6EDA};
  static constexpr Q15 C1_3_notw{(q15_t)0x4000};
...
tmp_5 = ((C0_3_notw) * ( decq(a[1].im,1)   -  decq(a[2].im,1)  )   + ( decq( widen<Q15>::run(a[0].re)  ,1)   - tmp_1) ) ;
res[1].re =  narrow<1,Q15>::run(tmp_5)  ;
tmp_6 = ((C0_3_notw) * ( decq(a[2].im,1)   -  decq(a[1].im,1)  )   + ( decq( widen<Q15>::run(a[0].re)  ,1)   - tmp_1) ) ;
res[2].re =  narrow<1,Q15>::run(tmp_6)  ;
tmp_7 = ( decq( decq(a[0].im,1)  ,1)   +  decq(( decq(a[1].im,1)   +  decq(a[2].im,1)  ) ,1)  ) ;
res[0].im = tmp_7;
tmp_2 = ( decq(a[1].im,1)   +  decq(a[2].im,1)  ) ;
tmp_3 = (C1_3_notw) * tmp_2 ;
tmp_8 = ((C0_3_notw) * ( decq(a[2].re,1)   -  decq(a[1].re,1)  )   + ( decq( widen<Q15>::run(a[0].im)  ,1)   - tmp_3) ) ;
res[1].im =  narrow<1,Q15>::run(tmp_8)  ;
tmp_9 = ((C0_3_notw) * ( decq(a[1].re,1)   -  decq(a[2].re,1)  )   + ( decq( widen<Q15>::run(a[0].im)  ,1)   - tmp_3) ) ;
res[2].im =  narrow<1,Q15>::run(tmp_9)  ;
...
tmp_3 = (C1_3_tw) * tmp_2 ;
tmp_17 = (tmp_1 + ( decq( widen<Q15>::run(a[0].re)  ,1)   - tmp_3) ) ;
tmp_4 = tmp_17;
tmp_5 = ( decq(a[2].re,1)   -  decq(a[1].re,1)  ) ;
tmp_6 = (C0_3_tw) * tmp_5 ;
tmp_7 = ( decq(a[1].im,1)   +  decq(a[2].im,1)  ) ;
tmp_8 = (C1_3_tw) * tmp_7 ;
tmp_18 = (tmp_6 + ( decq( widen<Q15>::run(a[0].im)  ,1)   - tmp_8) ) ;
tmp_9 = tmp_18;
res[1].re =  narrow<1,Q15>::run((w[0].re *  narrow<NORMALNARROW,Q15>::run(tmp_4)    - w[0].im *  narrow<NORMALNARROW,Q15>::run(tmp_9)   ) )  ;
tmp_10 = ( decq(a[2].im,1)   -  decq(a[1].im,1)  ) ;
tmp_11 = (C0_3_tw) * tmp_10 ;
tmp_19 = (tmp_11 + ( decq( widen<Q15>::run(a[0].re)  ,1)   - tmp_3) ) ;
tmp_12 = tmp_19;
tmp_13 = ( decq(a[1].re,1)   -  decq(a[2].re,1)  ) ;
tmp_14 = (C0_3_tw) * tmp_13 ;
tmp_20 = (tmp_14 + ( decq( widen<Q15>::run(a[0].im)  ,1)   - tmp_8) ) ;
tmp_15 = tmp_20;
res[2].re =  narrow<1,Q15>::run((w[1].re *  narrow<NORMALNARROW,Q15>::run(tmp_12)    - w[1].im *  narrow<NORMALNARROW,Q15>::run(tmp_15)   ) )  ;
tmp_21 = ( decq( decq(a[0].im,1)  ,1)   +  decq(( decq(a[1].im,1)   +  decq(a[2].im,1)  ) ,1)  ) ;
res[0].im = tmp_21;
res[1].im =  narrow<1,Q15>::run((w[0].re *  narrow<NORMALNARROW,Q15>::run(tmp_9)    + w[0].im *  narrow<NORMALNARROW,Q15>::run(tmp_4)   ) )  ;
res[2].im =  narrow<1,Q15>::run((w[1].re *  narrow<NORMALNARROW,Q15>::run(tmp_15)    + w[1].im *  narrow<NORMALNARROW,Q15>::run(tmp_12)   ) )  ;
...
tmp_0 = ( decq(a[1].re,1)   +  decq(a[2].re,1)  ) ;
tmp_1 = (C1_3_notw) * tmp_0 ;
tmp_5 = ((C0_3_notw) * ( decq(a[2].im,1)   -  decq(a[1].im,1)  )   + ( decq( widen<Q15>::run(a[0].re)  ,1)   - tmp_1) ) ;
res[1].re =  narrow<1,Q15>::run(tmp_5)  ;
tmp_6 = ((C0_3_notw) * ( decq(a[1].im,1)   -  decq(a[2].im,1)  )   + ( decq( widen<Q15>::run(a[0].re)  ,1)   - tmp_1) ) ;
res[2].re =  narrow<1,Q15>::run(tmp_6)  ;
tmp_7 = ( decq( decq(a[0].im,1)  ,1)   +  decq(( decq(a[1].im,1)   +  decq(a[2].im,1)  ) ,1)  ) ;
res[0].im = tmp_7;
tmp_2 = ( decq(a[1].im,1)   +  decq(a[2].im,1)  ) ;
tmp_3 = (C1_3_notw) * tmp_2 ;
tmp_8 = ((C0_3_notw) * ( decq(a[1].re,1)   -  decq(a[2].re,1)  )   + ( decq( widen<Q15>::run(a[0].im)  ,1)   - tmp_3) ) ;
res[1].im =  narrow<1,Q15>::run(tmp_8)  ;
tmp_9 = ((C0_3_notw) * ( decq(a[2].re,1)   -  decq(a[1].re,1)  )   + ( decq( widen<Q15>::run(a[0].im)  ,1)   - tmp_3) ) ;
res[2].im =  narrow<1,Q15>::run(tmp_9)  ;
