...
#ifndef _RADIX_F16_6_H
#define _RADIX_F16_6_H
...
struct radix<DIRECT,float16_t, 6,inputstrideenabled>{

static constexpr float16_t C0_6_tw{0.8660254037844386f16};
  static constexpr float16_t C1_6_tw{0.5f16};
  
static constexpr float16_t C0_6_notw{0.8660254037844386f16};
  static constexpr float16_t C1_6_notw{0.5f16};
...
complex<float16_t> a[6];
complex<float16_t> res[6];
...
***************/
template<int inputstrideenabled> 
struct radix<INVERSE,float16_t, 6,inputstrideenabled>{
