...
res[0] = vaddition(a[0] , a[1]) ;
res[1] = vsubstraction(a[0] , a[1]) ;
...
res[0] = vaddition(a[0] , a[1]) ;
res[1] = vcomplex_mulq(w[0] , vsubstraction(a[0] , a[1]) ) ;
...
res[0] = vaddition(a[0] , a[1]) ;
res[1] = vcomplex_mulq( vconjugate(w[0])   , vsubstraction(a[0] , a[1]) ) ;
