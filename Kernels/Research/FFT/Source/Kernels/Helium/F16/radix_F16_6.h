...
#ifndef _RADIX_VECTOR_F16_6_H
#define _RADIX_VECTOR_F16_6_H
...
struct radixVector<DIRECT,float16_t, 6,inputstrideenabled>{

static constexpr complex<float16_t> C0_6_tw{-0.5f16, -0.8660254037844386f16};
  static constexpr complex<float16_t> C1_6_tw{-0.5f16, 0.8660254037844386f16};
  static constexpr complex<float16_t> C2_6_tw{0.5f16, -0.8660254037844386f16};
  
static constexpr complex<float16_t> C0_6_notw{-0.5f16, -0.8660254037844386f16};
  static constexpr complex<float16_t> C1_6_notw{-0.5f16, 0.8660254037844386f16};
  static constexpr complex<float16_t> C2_6_notw{0.5f16, -0.8660254037844386f16};
...
***************/
template<int inputstrideenabled> 
struct radixVector<INVERSE,float16_t, 6,inputstrideenabled>{
...
#endif /* #ifndef _RADIX_VECTOR_F16_6_H */