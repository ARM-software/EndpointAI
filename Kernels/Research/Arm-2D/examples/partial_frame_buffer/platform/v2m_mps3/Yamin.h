...
#include "system_Yamin.h"                   /* System Header */
...
/*------------------- FPGA I/O ----------------------------------------------*/
typedef struct /* see "Application Note AN540 Yamin FPGA for MPS3" */
{
  __IOM  uint32_t LED;                       /* Offset: 0x000 (R/W)  LED connections */
  __IOM  uint32_t YAMINCTRL;                 /* Offset: 0x004 (R/W)  Yamin Control signals */
...
/* FPGAIO_YAMINCTRL Register Definitions */
#define FPGAIO_YAMINCTRL_SPNIDEN_Pos      3                                              /* FPGAIO YAMINCTRL.SPNIDEN:  position */
#define FPGAIO_YAMINCTRL_SPNIDEN_Msk     (1UL << FPGAIO_YAMINCTRL_SPNIDEN_Pos)           /* FPGAIO YAMINCTRL.SPNIDEN:  mask */

#define FPGAIO_YAMINCTRL_SPIDEN_Pos       2                                              /* FPGAIO YAMINCTRL.SPIDEN:  position */
#define FPGAIO_YAMINCTRL_SPIDEN_Msk      (1UL << FPGAIO_YAMINCTRL_SPIDEN_Pos)            /* FPGAIO YAMINCTRL.SPIDEN:  mask */

#define FPGAIO_YAMINCTRL_NIDEN_Pos        1                                              /* FPGAIO YAMINCTRL.NIDEN:  position */
#define FPGAIO_YAMINCTRL_NIDEN_Msk       (1UL << FPGAIO_YAMINCTRL_NIDEN_Pos)             /* FPGAIO YAMINCTRL.NIDEN:  mask */

#define FPGAIO_YAMINCTRL_DBGEN_Pos        0                                              /* FPGAIO YAMINCTRL.DBGEN:  position */
#define FPGAIO_YAMINCTRL_DBGEN_Msk       (1UL /*<< FPGAIO_YAMINCTRL_DBGEN_Pos*/)         /* FPGAIO YAMINCTRL.DBGEN:  mask */

/* FPGAIO_BUTTON Register Definitions */
#define FPGAIO_BUTTON_Buttons_Pos         0                                              /* FPGAIO YAMINCTRL.Buttons:  position */
#define FPGAIO_BUTTON_Buttons_Msk        (3UL /*<< FPGACTRL_BUTTON_Buttons_Pos*/)        /* FPGAIO YAMINCTRL.Buttons:  mask */
...
/*------------------- TCM Gating Unit --------------------------------------------*/
typedef struct /* see "Yamin Engineering Specification" */
{
