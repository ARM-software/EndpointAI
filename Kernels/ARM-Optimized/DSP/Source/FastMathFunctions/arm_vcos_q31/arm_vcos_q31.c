 ...
 * Title:        arm_vcos_q31.c
 * Description:  Fast vectorized cosine calculation for Q.31 values
 *
 * $Date:        05 Aug 2022
 * $Revision:    V1.0.0
 *
...
void arm_vcos_q31_mve(const q31_t * ptheta, q31_t * pCosVal, uint32_t blockSize)
{
    ...
    VCOS_Q31(ptheta, pCosVal, blockSize);
    ...
    do {
        ...
        vst1q_p(pCosVal, vcos_q31(vecAngle), p);
        /*
