...
#ifndef ARM_IIR8TH_ORDER_H
#define ARM_IIR8TH_ORDER_H
...
/**
 * @brief Instance structure for the 8th order floating-point IIR.
 */
...
void            arm_iir8_f32(const arm_iir8_instance_f32 * S, const float32_t * pSrc,
...
#define IIR_8_COEF_BUF_SZ          ((((IIR_8_ORDER + 1) + 3) / 4) * 8)
...
void            arm_iir8_f32_mve(const arm_iir8_instance_f32 * S, const float32_t * pSrc,
                                    float32_t * pDst, uint32_t blockSize);

#endif

#endif                          // ARM_IIR8TH_ORDER_H
