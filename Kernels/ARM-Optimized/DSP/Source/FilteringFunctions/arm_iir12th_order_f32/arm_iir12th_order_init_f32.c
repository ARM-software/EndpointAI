 ...
 * Title:        arm_iir12th_order_init_f32.c
 ...
 * @param[in,out] S             points to an instance of the floating-point IIR12 structure.
                          ...
                          uint32_t blockSize)
{
    ...
    for (int i = order + 1; i < (IIR_12_COEF_BUF_SZ / 2); i++)
        pModCoef[i] = 0;

    /* copy denominator coefs */
    pModCoef += (IIR_12_COEF_BUF_SZ / 2);
