...
void arm_iir12_f32(const arm_iir12_instance_f32 * S, const float32_t * pSrc, float32_t * pDst,
                 uint32_t blockSize)
{
...
void arm_iir12_f32_mve(const arm_iir12_instance_f32 * S, const float32_t * pSrc, float32_t * pDst,
                       uint32_t blockSize)
{
    ...
    float32x4_t     vecCoefNum2, vecCoefDen2;
    ...
    vecCoefNum2 = *(float32x4_t *) (pNumCoef + 8);

    vecCoefDen0 = *(float32x4_t *) pDenCoef;
    vecCoefDen1 = *(float32x4_t *) (pDenCoef + 4);
    vecCoefDen2 = *(float32x4_t *) (pDenCoef + 8);
