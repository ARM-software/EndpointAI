...
Contrary to the CMSIS-DSP version of the SVM, the version
included in this example has no optimizations for vector architectures.
...
/*
 PDM buffer ID.
 It is used for debugging. Each time a new buffer of samples is
